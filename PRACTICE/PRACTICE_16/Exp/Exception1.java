...
/*Java float и double типы, как и почти любой другой язык
(и почти любой аппаратный блок FP), реализуют стандарт IEEE 754
...
Целочисленная арифметика (реализованная как представление с дополнением до двух в Java
и большинстве других языков и оборудования) отличается и не имеет специальных значений бесконечности
или NaN, поэтому создание исключений является полезным поведением.
 */
